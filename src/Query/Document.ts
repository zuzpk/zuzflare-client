...
import { stripAutoGeneratedFields } from "../lib/normalization";
...
class DocumentReference<T = any> {
     ...
     * Auto-generated fields (_createdAt, _updatedAt, _id, _seq) are automatically excluded.
     */
    async update(data: Partial<T>): Promise<void> {
        const filteredData = stripAutoGeneratedFields(data as Record<string, unknown>) as Partial<T>;
        await this.client.send(FlareAction.WRITE, {
            collection: this.collection,
            docId: this.id,
            data: filteredData,
     ...
     * Auto-generated fields are automatically excluded from the update.
     */
